package com.cloud.erp.config.cache;
...
public class RedisCacheConfig extends CachingConfigurerSupport {
    ...
    public CacheManager cacheManager(RedisConnectionFactory factory) {
        ...
        om.activateDefaultTyping(new ObjectMapper().getPolymorphicTypeValidator(),
        ...
        RedisCacheManager cacheManager =
            RedisCacheManager.builder(factory).cacheDefaults(config.entryTtl(expireTime)).build();
        return cacheManager;
    }
